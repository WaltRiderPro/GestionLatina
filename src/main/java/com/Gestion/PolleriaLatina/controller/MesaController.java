...
public class MesaController {
  ...
  @PostMapping("/guardar")
  @PreAuthorize("hasAuthority('MESAS_CREAR') or hasAuthority('MESAS_EDITAR')")
  ...
  @PreAuthorize("hasAuthority('MESAS_ELIMINAR')")
  ...
  @PreAuthorize("hasAuthority('MESAS_CREAR')")
  ...
  @PreAuthorize("hasAuthority('MESAS_EDITAR')")
